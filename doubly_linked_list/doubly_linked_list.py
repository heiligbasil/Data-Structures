...
class DoublyLinkedList:
    ...
    def add_to_head(self, value):
        ...
        # Possible scenarios? This needs to be the head, update previous head, increase length
        # Edge cases? -if self.head is None then there is no list and no no tail
        # No tail? -New head becomes tail as well
        self.length+=1
